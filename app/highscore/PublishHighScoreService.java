    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(highscore.PublishHighScoreService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = highscore.PublishHighScoreService.class.getResource(".");
            url = new URL(baseUrl, "http://playground.big.tuwien.ac.at:8080/highscoreservice/PublishHighScoreService?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://playground.big.tuwien.ac.at:8080/highscoreservice/PublishHighScoreService?wsdl', retrying as a local file");
